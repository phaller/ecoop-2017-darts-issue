...
Stockholm, Sweden\\
\orcid{0000-0002-2659-5271}\\ %ORCIDs are optional but highly recommended; for registration, please visit https://orcid.org/register
\email{phaller@kth.se}\\

Michael Pradel\\
TU Darmstadt\\
Darmstadt, Germany\\
\orcid{yyy}\\ %ORCIDs are optional but highly recommended; for registration, please visit https://orcid.org/register
...
\inputtocentry{darts-sample-article}
